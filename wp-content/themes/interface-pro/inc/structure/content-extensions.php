...
add_action( 'interface_gallery_two_column_template_content', 'interface_gallery_two_column_template_content', 10 );
/**
 * Displays the two column gallery content
 */
function interface_gallery_two_column_template_content() { ?>
	<div id="content">
		...
		<div class="filterable-grid column clearfix">
			...
			while ( $the_query->have_posts() ) :
				...
				$output = '<div class="gal-image one-half" data-id="id-'.$count.'" data-type="';
				...
				$output .='">';
					if ( has_post_thumbnail() ) {
				      ...
				      $output .= '<a  rel="next" class="gallery-fancybox" href="' .$large[0]. '" title="' .the_title( '', '', false ). '">';
...
add_action( 'interface_gallery_four_column_template_content', 'interface_display_gallery_four_column_content', 10 );
/**
 * Displays the four column gallery content
 */
function interface_display_gallery_four_column_content() { ?>
	<div id="content">
		<ul class="gal-filter clearfix">
			<li class="active no-padding-left"><a href="javascript:void(0)" class="all" title="All"><?php _e('All','interface');?></a></li>/
			<?php
			...
			while ( $the_query->have_posts() ) :
				$the_query->the_post();
				$terms = get_the_terms( $post->ID, 'gallery_category' );
				$output = '<div class="gal-image one-fourth" data-id="id-'.$count.'" data-type="';
          		if ( $terms && ! is_wp_error( $terms ) ) : 
			         foreach ($terms as $term){
			         	$output .= strtolower(preg_replace('/\s+/', '-', $term->name)).' ';
			         }
...
add_action( 'interface_testimonial_page_template_content', 'interface_display_testimonial_page_template_content', 10 );
/**
 * Displays the testimonial content
 */
function interface_display_testimonial_page_template_content() { ?>
<div id="content">
 <?php get_sidebar( 'testimonial-page' ); ?>
</div>
<?php
 } 
/****************************************************************************************/

add_action( 'interface_services_page_template_content', 'interface_display_services_page_template_content', 10 );
/**
 * Displays the services content
 */
function interface_display_services_page_template_content() { ?>
<div id="content">
...
add_action( 'interface_ourteam_page_template_content', 'interface_display_ourteam_page_template_content', 10 );
/**
 * Displays the Ourteam content
 */
function interface_display_ourteam_page_template_content() { ?>
<div id="content">
 <?php get_sidebar( 'ourteam' ); ?>
</div>
<?php } ?>
