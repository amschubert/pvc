<?php
/**
 * Interface Pro defining constants, adding files and WordPress core functionality.
 *
...
/**
 * This function defines the Interface Pro theme constants
 *
 * @since 1.0
 */
...
function interface_load_files() {
	...
	//require_once( INTERFACE_FUNCTIONS_DIR . '/update_notifier.php' );
}
